...
for md=1:4
    ...
    for curfile =1:length(files)
        ...
        %% 去掉不必要的event
        tmpEEG0 = pop_selectevent( EEG0, 'type',{'3'},'deleteevents','on');
        ...
        for idev=2
            ...
            tmpEEG = pop_selectevent( EEG, 'type',{'3'},'deleteevents','on');
...
save('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\epochID.mat','epochID')



%%
load('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\epochID.mat')
slide_data=[];
...
time=EEG.times;
save('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intraday_slidedata.mat','slide_MMN','slide_P3a','chanlocs','time')

%% PLOT within-sub correlation

load('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intraday_slidedata.mat')
...
within_pvalue=p;
save('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intraday_xcorr.mat','cof_XC','is_significant','non_significant')
...
save('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intraday_statistics.mat','results_bonferroni','stats','chanlocs','time')
...
save('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intrasub_slidedata.mat','intrasub_MMN','intrasub_P3a','chanlocs','time')


%% intrasub statistics 3
load('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intrasub_slidedata.mat')
cof_XC=[];cof_lag=[];
...
non_significant(ichan,P3a)= 4*91-sum(sum(is_significant{ichan,P3a}));

    end
end
a=1-sum(non_significant(:,1))/(9*4*91);b=1-sum(non_significant(:,2))/(9*4*91);
save('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intrasub_xcorr.mat','cof_XC','non_significant','is_significant','chanlocs','time')
...
save('G:\passiveexp22222\data\4thanalysis\MVPA_dataNresult\intrasub_statistics.mat','results_bonferroni','stats')
